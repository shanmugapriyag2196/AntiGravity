        ...
        <div className="notifications-container" style={{ display: 'grid', gridTemplateColumns: '250px 1fr 250px', gap: '24px', maxWidth: '1128px', margin: '0 auto', padding: '24px' }}>
            <aside>
                <div className="card" style={{ padding: '16px' }}>
                    ...
                    <div style={{ fontSize: '14px', color: '#666', marginBottom: '8px' }}>You have {notifications.length} new notifications</div>
                ...
                <section className="card" style={{ padding: '0' }}>
                    <div>
                        {notifications.length === 0 ? (
                            <div style={{ padding: '24px', textAlign: 'center', color: '#666' }}>No notifications</div>
                        ) : (
                                ...
                                <div key={notif.id} style={{ padding: '16px', display: 'flex', gap: '12px', borderBottom: '1px solid #eef3f8', cursor: 'pointer' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '8px' }}>
                                        ...
                                        <MoreHorizontal
                                            ...
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                if (window.confirm('Dismiss notification?')) handleDelete(notif.id);
                                            }}
